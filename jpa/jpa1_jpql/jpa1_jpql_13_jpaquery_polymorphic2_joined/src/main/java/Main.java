...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JPAUtil.setup("create table EMPLOYEE ( employee_id int, dtype VARCHAR(20), name VARCHAR(20), salary int)");
        JPAUtil.droptable("drop table MANAGER");
        JPAUtil.setup("create table MANAGER ( employee_id int, department VARCHAR(20))");
